...
```javascript
import gcusum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcusum@v0.0.9-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gcusum/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/blas-ext-base-gcusum/actions/workflows/test.yml?query=branch:v0.0.9
